...
namespace ApplicationLogicComponent.DataOperations
{
    ...
    public class DataOperationsManager
    {
        ...
        private SiteMethods siteMethods;
        #endregion
        ...
        #region Methods
            ...
            private void Init()
            {
                ...
                this.SiteMethods = new SiteMethods(this.DataManager);
            }
            #endregion
        ...
        #region Properties
            ...
            #region SiteMethods
            public SiteMethods SiteMethods
            {
                get { return siteMethods; }
                set { siteMethods = value; }
            }
            #endregion
